...
const Adelaide = () => {
  window.location.replace('https://www.academicjobs.com/adelaide');
  ...
  return (
    <div className="">
      <Helmet>
        <title> Teaching Jobs Adelaide</title>
        <meta
          name="description"
          content="Don’t miss this chance to work in one of the best academic environments in the world. Apply now for your dream academic job in Gold Coast! "
        />
        <meta
          name="keywords"
          content="Adelaide Teaching Jobs Australia, Adelaide TeachingJobs"
        />
      </Helmet>
