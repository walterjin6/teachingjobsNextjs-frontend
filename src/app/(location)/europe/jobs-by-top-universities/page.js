            ...
            <div className="hero-content flex-col xl:flex-row gap-8 mx-auto max-w-full">
              ...
              <div>
                <h1 className="text-3xl font-bold text-aj">
                  Find the best Europe universities to work for here... Use
                  university rankings to search for jobs in higher education.
                </h1>

                <p className="py-1">
                  All academic positions in Europe can be found through the No.1
                ...
                <p className="py-1">
                  Use the European university rankings in your search for the
                  perfect academic career…
                </p>
