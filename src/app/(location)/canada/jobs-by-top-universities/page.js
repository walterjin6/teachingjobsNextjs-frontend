...
export const metadata = {
  ...
  title: {
    absolute: 'The Best Universities to Work for in Canada', //Option 2 overrides the title in layout.tsx
  },
  description:
            ...
            <div className="hero-content flex-col xl:flex-row gap-8 mx-auto max-w-full">
              ...
              <div>
                <h1 className="text-3xl font-bold text-aj">
                  Find the best Canada universities to work for here... Use
                  university rankings to search for jobs in higher education.
                </h1>

                <p className="py-1">
                  All university jobs in Canada can be found through the No.1
                  job board, Academic Jobs. The 'find employers' page helps you
                ...
                <p className="py-1">
                  ...
                  achievements, and culture. Join the academic talent pool to
                  manage all your academic affairs and professional networks.
                </p>
                <p className="py-1">
                  Use the Canadian university and college rankings in your
                  search for the perfect academic job…
                </p>
