      ...
      <main>
          ...
          <div className="hero max-h-fit bg-slate-200 py-8">
            <div className="container mx-auto">
              <div className="hero-content flex-col lg:flex-row gap-8">
                <Image
                  src="/academic-job-postings/jordan-peterson.jpg"
                ...
                <div>
                  ...
                  <p className="py-6">
                    {countryRegionPlural()} HR professionals love how simple and
                    affordable it is to post jobs that target the best local &
                    global talent. We understand the importance of finding the
        ...
        <section className="container mx-auto px-4 mt-12">
          ...
          <h2 className="text-center mb-4">
            CoConnect with Elite Higher Education Leaders:nnect with{' '}
            {countryRegionPlural()} Academic Elite on the Premier Job Board
          </h2>
              ...
              <figure className="px-10 pt-10">
                <div className="icon-ai">
                  <Image
                    ...
                    alt="Canada Elite Academic Talent"
                  />
                </div>
              </figure>
              <div className="card-body items-center text-center">
          ...
          <div className="card card-side bg-slate-100 shadow-xl my-16 px-6 grid sm:grid-cols-1 md:grid-cols-2">
            <figure>
              <Image
                ...
                alt="Canada academic networking"
          ...
          <div className="card card-side bg-sky-50 shadow-xl my-16 px-6 grid sm:grid-cols-1 md:grid-cols-2">
            <figure className="lg:order-1">
              <Image
                ...
                alt="Canada Great Customer Service with the Lowest Prices"
                className="w-full lg:max-w-lg rounded-xl m-6"
              />
            </figure>
            <div className="card-body w-full">
              <h2 className="card-title">
                Exceptional Customer Service with the Lowest&nbsp;fees
              </h2>
              <p className="max-w-screen-sm">
            ...
            <div className="card bg-slate-100 shadow-xl">
              ...
              <div className="card-body items-center text-center">
                ...
                <p>
                  ...
                  Chancellors & Presidents to executive management teams.
                </p>
              </div>
            </div>
          ...
          <div className="card card-side bg-slate-100 shadow-xl my-16 px-6 grid sm:grid-cols-1 md:grid-cols-2">
            <figure>
              <Image
                ...
                alt="Access to thousands of top global academics Canada"
                className="w-full lg:max-w-lg rounded-xl m-6"
              />
            </figure>
            <div className="card-body w-full">
          ...
          <div className="container mx-auto">
            ...
            <div className="text-col-2">
              ...
              <p className="mb-4">
                ...
                while maximising results and recruiter satisfaction. With access
                ...
                will be a perfect fit for your organisation.
              </p>
              <p className="mb-4">
