              ...
              <div className="hero-content flex-col lg:flex-row gap-8">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-aj">
                    Join the {countryRegionPlural()} No. 1 Academic Job Board &
                    Community
                  </h1>
                  <h4 className="">
                  ...
                  <p className="py-6">
                    the {countryRegionPlural()} HR professionals love how simple
                    and affordable it is to post jobs that target the best local
        ...
        <section className="container mx-auto px-4 mt-12">
          ...
          <div className="text-col-2">
            <p className="max-w-xl mx-auto">
              Leverage the power of the {countryRegionPlural()} No. 1 Academic
          ...
          <div className="container mx-auto">
            ...
            <div className="text-col-2">
              <p className="mb-4">
                ...
                Choosing Teaching Jobs means partnering with the{' '}
                {countryRegionPlural()}
