...
export default function myPage() {
  return (
    <main>
            ...
            <div className="hero-content flex-col xl:flex-row gap-8 mx-auto max-w-full">
              ...
              <div>
                <h1 className="text-3xl font-bold text-aj">
                  ...
                  Use university rankings to search for jobs in higher
                  education.
                </h1>

                <p className="py-1">
                  All academic positions in South America can be found through
                ...
                <p className="py-1">
                  Use the South American university rankings in your search for
                  the perfect academic job…
                </p>
      ...
      <div className=" m-8 mb-12 rounded-3xl max-w-screen-2xl mx-auto">
