...
export const metadata = {
  ...
  title: {
    absolute: "The Best Universities to Work for in New Zealand", //Option 2 overrides the title in layout.tsx
  },
  description:
        ...
        <div className="container mx-auto">
          <div className="hero-content flex-col xl:flex-row gap-8 mx-auto max-w-full">
            <Image
              ...
              alt="New Zealand Top Academic Employers"
            />
            <div>
              <h1 className="text-3xl font-bold text-aj">
              Find the best New Zealand universities to work for here...
Use university rankings to search for jobs in higher education.

              </h1>
        
              <p className="py-1">
              All uni jobs in New Zealand can be found through the No.1 job board, Academic Jobs. The 'find employers' page helps you explore all academic careers and current job openings, at the world’s top colleges and universities.</p>
              <p className="py-1">
              ...
              <p className="py-1">
              Use the New Zealand university rankings in your search for the perfect academic job…</p>
