              ...
              <figure className="px-10 pt-10">
                <div className="icon-ai">
                  <Image
                    ...
                    alt="Life Saving Customer Service & Support New Zealand"
                  />
                </div>
              </figure>
              <div className="card-body items-center text-center">
              ...
              <figure className="px-10 pt-10">
                <div className="icon-ai">
                  <Image
                    ...
                    alt="New Zealand Elite Academic Talent"
                  />
                </div>
              </figure>
              <div className="card-body items-center text-center">
